...
type SignatureCdnGetReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SignatureCdnGetReq) Reset() {
	*x = SignatureCdnGetReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignatureCdnGetReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignatureCdnGetReq) ProtoMessage() {}

func (x *SignatureCdnGetReq) ProtoReflect() protoreflect.Message {
	mi := &file_authentication_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignatureCdnGetReq.ProtoReflect.Descriptor instead.
func (*SignatureCdnGetReq) Descriptor() ([]byte, []int) {
	return file_authentication_proto_rawDescGZIP(), []int{8}
}

func (x *SignatureCdnGetReq) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *SignatureCdnGetReq) GetFilePath() string {
	if x != nil {
		return x.FilePath
	}
	return ""
...
type SignatureCdnGetResp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SignatureCdnGetResp) Reset() {
	*x = SignatureCdnGetResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignatureCdnGetResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignatureCdnGetResp) ProtoMessage() {}

func (x *SignatureCdnGetResp) ProtoReflect() protoreflect.Message {
	mi := &file_authentication_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignatureCdnGetResp.ProtoReflect.Descriptor instead.
func (*SignatureCdnGetResp) Descriptor() ([]byte, []int) {
	return file_authentication_proto_rawDescGZIP(), []int{9}
}

func (x *SignatureCdnGetResp) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
var file_authentication_proto_rawDesc = []byte{
	...
	0x28, 0x03, 0x52, 0x03, 0x75, 0x69, 0x64, 0x22, 0x42, 0x0a, 0x12, 0x53, 0x69, 0x67, 0x6e, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x43, 0x64, 0x6e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x12, 0x10, 0x0a,
	...
	,
}
...
var file_authentication_proto_goTypes = []interface{}{
	...
	(*SignatureCdnGetReq)(nil),       // 8: service.SignatureCdnGetReq
	(*SignatureCdnGetResp)(nil),      // 9: service.SignatureCdnGetResp
}
var file_authentication_proto_depIdxs = []int32{
	...
	8, // 4: service.Authentication.SignatureCdnGet:input_type -> service.SignatureCdnGetReq
	1, // 5: service.Authentication.GenerateToken:output_type -> service.GenerateTokenResp
	3, // 6: service.Authentication.GenerateRefreshToken:output_type -> service.GenerateRefreshTokenResp
	5, // 7: service.Authentication.VerifyToken:output_type -> service.VerifyTokenResp
	7, // 8: service.Authentication.VerifyRefreshToken:output_type -> service.VerifyRefreshTokenResp
	9, // 9: service.Authentication.SignatureCdnGet:output_type -> service.SignatureCdnGetResp
...
func file_authentication_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_authentication_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignatureCdnGetReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_authentication_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignatureCdnGetResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

...
func MeSigUpdateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MeSigUpdateReq
		...
		l := me.NewMeSigUpdateLogic(ctx, svcCtx)
		if err := l.MeSigUpdate(&req); err != nil {
